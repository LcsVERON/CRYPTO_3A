...
```
cd existing_repo
git remote add origin https://moule.informatique.univ-paris-diderot.fr/choucrou/crypto_3a.git
git branch -M main
...
- [ ] [Set up project integrations](https://moule.informatique.univ-paris-diderot.fr/choucrou/crypto_3a/-/settings/integrations)
